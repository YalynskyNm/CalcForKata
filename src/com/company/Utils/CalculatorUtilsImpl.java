...
public class CalculatorUtilsImpl implements CalculatorUtils {
    ...
    public void startCalculate(String number_1, String operator, String number_2) {
        ...
        if (numb_1IsRome && numb_2IsRome){
            if (arabicNumber_1 < arabicNumber_2 && operator.equals("-")){
                throw new IncorrectInputExceptions("В римской системе нет отрицательных чисел");
            }
        }
